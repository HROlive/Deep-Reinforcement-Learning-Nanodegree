...
class Agent():
    ...
    def __init__(self, num_agents, state_size, action_size, random_seed):
        ...
        self.epsilon_decay = 1 / (EPSILON_END * UPDATE_NUM)
    ...
    def step(self, state, action, reward, next_state, done, agent_number):
        ...
        # Learn every UPDATE_EVERY timesteps, if enough samples are available in memory
    ...
    def learn(self, experiences, gamma, agent_number):
        ...
        self.epsilon = max(self.epsilon, self.epsilon_threshold)
        self.noise.reset()
